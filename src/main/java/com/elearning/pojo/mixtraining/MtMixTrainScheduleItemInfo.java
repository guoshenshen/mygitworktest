...
public class MtMixTrainScheduleItemInfo {
    private Integer id;
    ...
    public String getSortLable() {
        return sortLable;
    }

    public void setSortLable(String sortLable) {
        this.sortLable = sortLable;
    }

    public MtMixTrainScheduleItemInfo() {
        super();
    }
