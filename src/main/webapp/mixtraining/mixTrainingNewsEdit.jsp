        ...
        <div class="mainContent content">
            ...
            <div class="homezoneall">
                ...
                <div class="homezonecontent">
                    ...
                    <br/><br/>
                    <form action="../mtTrainNews/updateNews.do" method="post" id="form1" class="form-horizontal">
                        <input type="hidden" name="filterFlag" value="false"/>
                        <input type="hidden" name="newsId" value="${news.newsId}"></input>
                        <div class="form-group">
                            <label for="newsTitle" class="col-sm-2 control-label">新闻标题：</label>
                            <div class="col-sm-8">
                                <input type="text" id="newsTitle" name="newsTitle" class="form-control" size="42" value="${news.newsTitle}"></input>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="newsContent" rows="5" cols="50" class="" name="newsContent">${news.newsContent}</textarea>
                            </div>
                        </div>
                    </form>
                    <div style="float:right;margin-right:50px;margin-bottom:10px">
                        <a href="../mtTrainNews/queryNews.do" class="btn btn-primary">返&nbsp;回</a>
            ...
            <div id="preview_news" style="display:none;cursor:default;">
                ...
                <p></p>
                <div id="preview_news_body" style="margin-left:3%;margin-right:3%"></div>
            </div>
            <!--首页 内容 end -->
            <!-- InstanceEndEditable -->
            <div class="homezoneall">
