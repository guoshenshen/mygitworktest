...
<head>
    ...
    <script type="text/javascript">
        var editor = "";
        function toUpdateTrainEffect() {
            var trainEffect = $("#conclusion").val();
        ...
        <div class="mainContent content">
            ...
            <div class="homezoneall">
                ...
                <div class="homezonecontent">
                    <br/><br/>
                    <form action="../mtMixTrainEffect/update.do" method="post" id="form1">
                        <input type="hidden" name="filterFlag" value="false"/>
                        <table width="60%" align="center">
                            <tr>
                                <th width="20%" class="ctext">姓名：</th>
                                <td width="30%" class="ctext">
                                    <input type='hidden' name='id' value='${trainSummaryForm.id}'/>
                                    ${trainSummaryForm.userName}</td>
                            ...
                            <tr>
                                <td colspan='4' align='center'>
                                    <textarea id="conclusion" rows="30" cols="100" class="areaInput" name="conclusion">
                                        ${trainSummaryForm.conclusion}
                                    </textarea>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div style="float:right;margin-right:170px;margin-bottom:10px;margin-top:20px;">
                        <a href="../mtMixTrainEffect/detail.do" class="btn-blue-l">
                            <span class="btn-blue-r">返&nbsp;回</span>
                        </a>
                        <a href="javascript:void(0);" class="btn-blue-l" onclick="toUpdateTrainEffect();" style="margin-left:10px;">
