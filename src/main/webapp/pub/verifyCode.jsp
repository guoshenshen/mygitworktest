...
<%
  ...
  String base="23456789abcdefghkmnpqrstuvwxyz23456789ABCDEFGHKMNPQRSTUVWXYZ23456789";
  //备选汉字的长度
  ...
  //设置字体
    g.setFont(new Font(fontTypes[random.nextInt(fontTypesLength)], Font.BOLD, 34 + random.nextInt(6)));
  //将此汉字画到图片上
    g.drawString(rand, 32 * i + 10 + random.nextInt(8), 28);
  }
  //将认证码存入session
