    ...
    <div class="mainbody">
        ...
        <div class="mainContent content">
            ...
            <div id="contentbody">
                ...
                <div id="content_01">
                    <div class="gl_06_title" style="margin-top:-15px;">${exam.examTitle} 考试信息</div>
                </div>

                <div id="content_02">
                    <table class="table table-striped table-bordered batchOperation" width="60%" cellspacing="0" cellpadding="0" align="center">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><bean:write name="exam" property="totalTime"/></td>
                ...
                <div class="btnContainer">
                    <div class="clearfix">
                        <a href="../examManage/toExamManageHome.do" class="btn-orange-l"><span class="btn-orange-r">返&nbsp;&nbsp;回</span></a>
                    </div>
                </div>
            </div>
        </div>
