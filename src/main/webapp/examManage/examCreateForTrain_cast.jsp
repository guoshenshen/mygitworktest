            ...
            <div class="homezoneall">
                <div class="homezonecontent">
                    ...
                    <div class="gl_31_1" style="width:450px">
                        <span class="gl_11_yes">1、考试基本信息</span>
                    ...
                    <div id="content_02">
                        <form action="" id="ExamInfoForm" name="ExamInfoForm" method="post">
                            ...
                            <table class="table0 table table-striped table-bordered batchOperation" width="80%" cellspacing="0" cellpadding="0" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        value="<fmt:formatDate value='${examInfo.startTime}' pattern='yyyy-MM-dd HH:mm'/>" size=25/>
                                        <font color=red>&nbsp;*</font>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input name="endTime" id="endTime" class="Wdate" type="text"
                                            ...
                                            onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:false,readOnly:true})"
                                               value="<fmt:formatDate value='${examInfo.endTime}' pattern='yyyy-MM-dd HH:mm'/>" size=25/>
                                        <font color=red>&nbsp;*</font>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="isApply" name="isApply" value="1"
                                               <c:if test="${examInfo.isApply == 1}">checked</c:if> onclick="isapply()"/>
                                        是 &nbsp;&nbsp;&nbsp;
                                        <input type="radio" id="isApply" name="isApply" value="0"
                                               <c:if test="${examInfo.isApply == 0}">checked</c:if> onclick="isnotapply()"/>
                                        否
                                    </td>
                                </tr>
                                <tr id="isNeedApprove1" <c:if test="${examInfo.isApply == 0 }">style="display:none"</c:if> >
                                    ...
                                    <td>
                                        <input type="radio" name="isNeedApprove" id="isNeedApprove" value="1"
                                               <c:if test="${examInfo.isNeedApprove == 1}">checked</c:if> />
                                        是&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="isNeedApprove" id="isNeedApprove" value="0"
                                            <c:if test="${examInfo.isNeedApprove == 0}">checked</c:if> />
                                        否
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input type="radio" id="ifDisplayAnswer" name="ifDisplayAnswer" value="0"
                                                <c:if test="${examInfo.ifDisplayAnswer == 0 }">checked</c:if> />
                                        考试时间结束看答案&nbsp;&nbsp;&nbsp;
                                        <input type="radio" id="ifDisplayAnswer" name="ifDisplayAnswer" value="1"
                                                <c:if test="${examInfo.ifDisplayAnswer == 1 }">checked</c:if> />
                                        考试后立即看答案
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea name="examDescription" cols="60" rows="10" id="examDescription">
                            ...
                            <div class="container">
                                <button class="btn btn-info" type="button" onclick="window.location.href='../examManage/toExamManageHome.do?examForTrainFlag=1'">
                                    返回
                                </button>
                                <button class="btn btn-primary" type="button" onclick="return checkForm();">下一步</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    function examInfoInsert() {
        document.ExamInfoForm.action = "../examInfo/examInsert.do?examForTrainFlag=1";
        document.getElementById('ExamInfoForm').submit();
    }

    function examInfoUpdate() {
        document.ExamInfoForm.action = "../examInfo/examUpdate.do?examForTrainFlag=1&eid=${examInfo.ID}";
        document.getElementById('ExamInfoForm').submit();
    }
