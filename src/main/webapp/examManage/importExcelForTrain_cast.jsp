            ...
            <div class="homezoneall">
                <div class="homezonecontent">
                    ...
                    <div class="gl_06" style="border:0">
                        ...
                        <br/>
                        <div class="clr"></div>
                        <form name="form1" method="post" action="../examScoreFile.do?method=importExcel&examForTrainFlag=1" ENCTYPE="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href=javascript:openwindowtocenter('modelExcel/outputExcel.jsp?file=score.xls','<%=Constants.systemName%>',600,600)>
                                            <img src="/image/choice.jpg" border="0" style="height:30px;width:40px;"/>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center" style="padding-top: 30px;">
                                        ...
                                        <div class="btnContainer">
                                            <div class="clearfix">
                                                <a href="../examManage/toExamManageHome.do?examForTrainFlag=1&pageNo=1" class="btn-blue-l">
