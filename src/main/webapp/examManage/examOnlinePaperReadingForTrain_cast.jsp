                ...
                <div class="homezonecontent">
                    ...
                    <div id="content_02">
                                    ...
                                    <c:forEach var="ExamOnlinePaperReadingForm" items="${onlineReadingList}" varStatus="status">
                                        <tr>
                                            ...
                                            <c:if test="${ExamOnlinePaperReadingForm.readingStatus != Constants.S_PAPERAUDIT_NONEED}">
                                                ...
                                                <td align="center">
                                                    <a href="../examResultManage/toViewUserPaperByOperatorIdAndExamId.do?examForTrainFlag=1&eid=${ExamOnlinePaperReadingForm.examId}&operatorId=${ExamOnlinePaperReadingForm.employeeID}&replyId=${ExamOnlinePaperReadingForm.replyId}">
                                                        批改
                                                    </a>
                                                </td>
                                            </c:if>
                        ...
                        <div class="btnContainer">
                            <div class="clearfix">
                                <a href="../examManage/toExamManageHome.do?examForTrainFlag=1" class="btn-orange-l">
