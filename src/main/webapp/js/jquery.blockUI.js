...
/*
* process with the unblock enent, 
* bug fixed for the disable input after close the pop window under IE6, 7, 8
* by ffr
* 2012-10-12
*/
/*default is the first input of the last form, able to defined before pop window, 
* for example: selectusers script function in /message/messageInfoforadd.jsp
*/
var focusForm = "form:last";
$.blockUI.defaults.onUnblock = function(element, options){
	if(focusForm != ""){
		$("input[type='text']:first", focusForm).focus();
	}
}