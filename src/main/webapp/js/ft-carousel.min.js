! function(t) {
	...
	i.prototype = {
		...
		renBtns: function() {
			this.ele.append('<span class="carousel-btn carousel-prev-btn"><i class="fa fa-chevron-left"></i></span><span class="carousel-btn carousel-next-btn"><i class=" fa fa-chevron-right" ></i></span>')
		},
		animate: function(t) {
			var i = this,
