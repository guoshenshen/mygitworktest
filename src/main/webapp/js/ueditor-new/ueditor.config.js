...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"/uploadFile/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,filePath:"/uploadFile/"                   //附件修正地址，同imagePath
        ...
        ,imageManagerPath:"/uploadFile/"                                   //图片修正地址，同imagePath
        ...
        , toolbars:[
                    [ 
                        ...
                        'rowspacingtop', 'rowspacingbottom', 'lineheight', 'insertimage', 'attachment',
                        'customstyle', 'paragraph', 'fontfamily', 'fontsize',
                        'indent',
                        'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify',
                        'link', 'unlink', 'imagenone', 'imageleft', 'imageright', 'imagecenter',
                        'emotion', 'map',
                        'inserttable', 'deletetable', 'wordimage','preview'
                        ]
                ]
...
//        }
        ...
        //,initialStyle:'p{line-height:1.5em;font-size:14px};span{font-size:14px}'//编辑器层级的基数,可以用来改变字体等
